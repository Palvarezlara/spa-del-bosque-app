...
export default function CardServicio({ servicio, ...rest}) {
  ...
  const {sku, nombre, precio, categoria, duracionMin, img, imageUrl } = s;
  ...
  return (
    <div className="col-12 col-md-6 col-lg-3">
      <div className="card h-100 shadow-sm">
        {imgSrc && (
          <img src={imgSrc} className="card-img-top" alt={nombre} />
        )}
        <div className="card-body d-flex flex-column">
          <h3 className="h6">
            {nombre} {duracionMin ? <i className="bi bi-clock" /> : null}
          </h3>
